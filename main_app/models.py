...
from main_app.validators import ValidateRating, ValidateReleaseYear
...
class VideoGame(models.Model):
    ...
    release_year = models.PositiveIntegerField(validators=[ValidateReleaseYear("The release year must be between 1990 and 2023")])
    rating = models.DecimalField(max_digits=2,decimal_places=1, validators = [ValidateRating("The rating must be between 0.0 and 10.0")])
